...
connect_bd_intf_net [get_bd_intf_pins slave_1/S_AXI ] [get_bd_intf_pins myip_0/M01_AXI]
	...
	# Create interface connections
	connect_bd_intf_net [get_bd_intf_pins master_1/M_AXI ] [get_bd_intf_pins myip_0/S02_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_1/ACLK] [get_bd_pins myip_0/S02_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_1/ARESETN] [get_bd_pins myip_0/S02_AXI_ARESETN]
...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/myip_v1_1_tb_include.svh"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/myip_v1_1_tb.sv
